...
class AnimatorModel: NSObject {
    ...
    func elliotsShame() -> MonsterModel {
        ...
        let monsterBody = MCPartBody(textureName: "monsterBody", color: UIColor.redColor(), anchor: CGPoint(x: 0.5, y: 0.5))
        ...
        eye1.lockPoint = CGPoint(x: -47.419, y: 34.541)
        eye1.setScale(0.25)
        ...
        eye2.lockPoint = CGPoint(x: 47.419, y: 34.541)
        eye2.setScale(0.25)
        ...
        mouth.lockPoint = CGPoint(x: 0, y: -57.10)
        
        
        let arm1 = MCPartArm(textureName: "arm1", color: UIColor.whiteColor(), anchor: CGPoint(x: 0.15, y: 0.15))
        arm1.position = CGPoint(x: 55.54, y: -127.35)
        arm1.lockPoint = CGPoint(x: 55.54, y: -127.35)
        arm1.setScale(1)
        arm1.rotateToAngle(π/2 + 0.1)
        
        let arm2 = MCPartArm(textureName: "arm1", color: UIColor.whiteColor(), anchor: CGPoint(x: 0.15, y: 0.15))
        arm2.isMirroredPart = true
        arm2.position = CGPoint(x: -55.54, y: -127.35)
        arm2.lockPoint = CGPoint(x: -55.54, y: -127.35)
        arm2.setScale(1)
        ...
        leg1.lockPoint = CGPoint(x: 88.126, y: 1.978)
        leg1.setScale(1)
        ...
        leg2.lockPoint = CGPoint(x: -88.126, y: 1.978)
        leg2.setScale(1)
        ...
        hat.lockPoint = CGPoint(x: 0, y: 151.91)
        hat.setScale(0.4)
